...
public class PaBalls2016CS20 : Form{
	private ResourceManager rm = new ResourceManager("PaBalls2016CS20",
	...
	public PaBalls2016CS20(){
		this.Text = "PaBalls2016CS20";
		...
		timer = new System.Threading.Timer(PaBalls2016CS20_Timer, null, 0, nTimerInterval);
		isRunning = true;
	...
	public void PA_DoAppInitialize(){
		...
		//rm = new ResourceManager("PaBalls2016CS20",Assembly.GetExecutingAssembly());
	...
	public void PaBalls2016CS20_Timer(object sender){
		if(nPathID==0){
			PA_DoBallsMove();
		}else{
	...
	public static void Main(string[] args){
		Application.Run(new PaBalls2016CS20());
	}
}
